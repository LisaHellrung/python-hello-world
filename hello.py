...
print(4);
print(4 + 4);
print("Another Message"," AND Another Message");
...
#       You need the parantheses. Print is the function and you need to pass the argument inside the parantheses.
...
#       Using a single or double quotation mark produces the same results.
